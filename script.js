document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById('coupleNames').textContent = coupleNames || 'Burhan & Yunik'; // Default names
    ...
    function calculateCountdown() {
        const weddingDate = new Date('2025-04-21T11:00:00'); // Set your wedding date and time here (e.g., 3:00 PM)
    ...
    if (messageForm) {
        messageForm.addEventListener('submit', function(e) {
            ...
            fetch('https://burhan-yunik-tema-1.glitch.me/messages', {
                method: 'POST',
                headers: {
